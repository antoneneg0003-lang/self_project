# COMPLETE PROBLEM SOLVING ARCHITECTURE (Stabilized Version)

Core Principle:
Each phase has one dominant cognitive function.
No duplication.
Clear boundaries.
...
- Identify stakeholders (if applicable)
- Classify problem type (optimization, proof, explanation, prediction, design)
...
Purpose:
Build a structured representation of the problem.
...
B. Representation Engineering
    - Choose model form (algebraic, geometric, graph, probabilistic, algorithmic, simulation)
...
D. Causal Analysis (when applicable)
...
Output:
→ Structured and causally mapped model
...
Purpose:
Define the solution space clearly.
...
Output:
→ Clearly bounded solution space

==================================================================

## 4️⃣ GENERATION (Divergent Phase)
Dominant Function: Possibility Expansion

Purpose:
Create multiple candidate solutions.
...
Rule:
Never generate only one candidate.

Output:
→ Set of competing solution candidates

==================================================================

## 5️⃣ EVALUATION (Convergent Phase)
...
Output:
→ Selected candidate with justification

==================================================================

## 6️⃣ CONSTRUCTION (Execution Phase)
...
Output:
→ Concrete artifact (solution, model, proof, design, plan)

==================================================================

## 7️⃣ VALIDATION (Robustness Testing)
...
If failure:
→ Loop back to Phase 4 or 2 depending on cause

Output:
→ Verified solution OR identified failure
...
## 1️⃣1️⃣ GENERALIZATION (Schema Formation)
...
## 1️⃣2️⃣ REINFORCEMENT LOOP (Meta-Level)
Dominant Function: Adjusting based on feedback from step_10(introspection+retrospection)
...
Loop:
Returns to Phase 1 for next problem
==================================================================
